...
const SUser = new Schema<IUser>(
    {
        ...
        email: {type: String, required: [true, "Please enter an e-mail."], validate:{validator:validator.isEmail,message:"Please enter a valid e-mail."}, unique: true, minlength: 5, maxlength: 90, select: false},
        portrait: {type: String, default: ""},
        phone: {type: String, required: [true, "Please enter a valid phone number"], unique: true, minlength: 4, maxlength: 18, select: false},
        ...
        interviewDate: {type: Date, default: 0},
